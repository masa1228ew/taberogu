...
public class CategoryController {
	 private final ShopRepository shopRepository;
	  private final CategoryRepository categoryRepository;        
	     ...
	     @GetMapping
	     public String index(Model model,@PageableDefault Pageable pageable,@PathVariable(name = "shopId") Integer shopId,@PathVariable(name = "categoryId") Integer categoryId) {
...
//	    	 Category category =  categoryRepository.getReferenceById();  
	     ...
	     public String show(Model model,@PathVariable(name = "shopId") Integer shopId,@PathVariable(name = "categoryId") Integer categoryId,@PageableDefault Pageable pageable){
